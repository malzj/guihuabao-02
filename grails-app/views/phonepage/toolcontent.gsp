...
<div class="nav-1">
    <div class="page">
        <g:link action="toolcontent" id="${id}" params="[offset: offset.toInteger()-1]" style="border-right: 2px solid #03a9f5;">上一页</g:link><g:link action="toolcontent" id="${id}" params="[offset: offset.toInteger()+1]">下一页</g:link>
    </div>
</div>
<div class="content-1">
