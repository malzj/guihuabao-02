...
<body class="home">
	<input id="module" type="hidden" value="index">
...
<div class="site-head site-head-fixed">
	...
	<div id="secParent" class="sec-parent">
		<!-- 第一屏 -->
		<div class="section hm-sec1">
			<div id="ad">
			...
			<div class="sec-content" style="top:35%;">
				<div class="zs-introduct">
					...
					<p>目标、任务、权责清晰划分，人员、流程清楚明了，日期、标准精确标明，每一位员工都知道自己在什么时间应该将什么任务按照什么样的标准完成至何种程度。<br />
						没有委屈、误会、不满、借口…… 也没有莫名其妙、推诿拖延……<br />
						实现员工自身价值，提升企业工作效率，规划宝可以轻松做到。</p>
				</div>
			</div>
		</div>
		<!-- 第四屏 -->
		
		<div class="section hm-sec4">
			<div class="sec-content">
				<h2>他们怎么说？</h2>
				<div class="hm-mod-js">1000+个团队的共同选择</div>
				<div class="hm-mod-wecan">
					<!-- 滚动开始 -->
				<div class="demo">
					<div class="bx_wrap">
						<ul id="demo2">
		...
		<div class="footer-rightCol">
			...
			<div class="footer-appdown">
				<div class="item iphone">
					...
					<a href="" target="_blank">iPhone客户端下载</a>
				</div>
				<div class="item android">
					<p class="img-qrcode img-qrcode-andriod"></p>
					<a href="" target="_blank">安卓客户端下载</a>
				</div>
			</div>

		</div>
		<div class="copyright clearfix">
			<a class="g-site" target="_blank" href="">Copyright © 2012 IZP Technologies Co.,Ltd. All Rights Reserved.京ICP备13047936号-3&nbsp;京公网安备</a>
		</div>
	</div>
</div>
