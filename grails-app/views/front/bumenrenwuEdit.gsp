        ...
        <section class="wrapper" style="margin-top: 94px;">
            <div class="testPaper">
                ...
                <g:form url="[controller:'front',action:'bumenrenwuUpdate']" class="clearfix" style="width:370px;min-height:286px;margin:30px auto;border:1px solid #dedede;box-shadow: 0 0 3px #dedede;;border-top:4px solid #27bdff;background: #fff;padding:15px;">
                    ...
                    <input id="sid" type="hidden" class="form-control" name="id" value="${bumenrenwuInstance.id}"/>

                    <div class="clearfix">
                        <label for="title" class="f-l control-label">任务标题：</label>
                        <div class="f-l" style="position: relative;">
                            <input id="title" class="form-control" name="title" value="${bumenrenwuInstance.title}"/><br/>
                    ...
                    <div class="clearfix">
                        ...
                        <div class="f-l" style="position: relative;">
                            <input id="content"  class="form-control" name="content" value="${bumenrenwuInstance.content}" /><br/>
                    ...
                    <div class="clearfix">
                        ...
                        <div class="f-l" style="position: relative;">
                            <input id="etime"  class="form-control" name="etime" value="${bumenrenwuInstance.etime}" title="结束时间不能小于开始时间，并且不能大于第二年年底"/><br/>
