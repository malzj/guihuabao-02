        ...
        <div class="test-question reset">
            <div class="test-title">企业组织架构</div>
                ...
                <div style="text-align: center;margin:90px 0 63px; ">
                    <g:link action="selectDepartmentEdit" class="btn btn-set" style="width:118px;">返回上一步</g:link>
                    <g:link action="bumenrenwuList" class="btn btn-info" style="width:118px;margin-left: 24px;">确认完成</g:link>
                </div>
                </div>
        </div>
    </section>
