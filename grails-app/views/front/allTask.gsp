                ...
                <div class="col-cell">
                    <div class="toolkit">
                        ...
                        <div class="shaixuan">
                            ...
                            <ul>
                                ...
                                <li>
                                    <g:link action="allTask" params="[selected: 1]">紧急且重要</g:link>
                                </li>
                                <li>
                                    <g:link action="allTask" params="[selected: 2]">紧急不重要</g:link>
                                </li>
                                <li>
                                    <g:link action="allTask" params="[selected: 3]">重要不紧急</g:link>
                                </li>
                                <li>
                                    <g:link action="allTask" params="[selected: 4]">不重要不紧急</g:link>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="e-list-group">
                        <ul class="e-list fzalltasklist">
                            <g:if test="${allTaskInstance}">
                                <g:each in="${allTaskInstance}" status="i" var="taskInfo">
                                    <li>
                    ...
                    <div class="pagination">
                        <g:paginate total="${allTaskInstanceTotal}" params="[selected: selected]" />
                    </div>
                </div>
