...
<section id="container" >
    ...
    <section id="main-content">
        <section class="wrapper mt80">
                <g:form class="form-horizontal tasi-form" url="[controller:'login',action:'informSave']" method="post"  enctype= "multipart/form-data">
                    ...
                    <div class="mt25">
                        ...
                        <div class="textarea b-k">
                            <textarea id="editor_id" name="introduction" style="width:100%;height:300px;" placeholder="内容"></textarea>
                        </div>
                    </div>
                </g:form>
            </section>
