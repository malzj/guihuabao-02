...
<section id="container" >
    ...
    <section id="main-content">
        <section class="wrapper mt80">
            ...
            <g:form class="form-horizontal tasi-form" url="[controller:'login',action:'informUpdate']" method="post"  enctype= "multipart/form-data">
                ...
                <div class="mt25">
                    <g:hiddenField name="id" value="${informInstance.id}" ></g:hiddenField>
                    %{--<g:hiddenField name="version" value="${informInstance.version}" ></g:hiddenField>--}%
                    <div class="form-group">

                        <div class="col-lg-12">
                            <input class="form-control" type="text" name="title" value="${informInstance.title}" />
                        </div>
                    </div>
                    <div class="textarea">
                        <textarea id="editor_id" name="content" style="width:100%;height:500px;">${informInstance.introduction}</textarea>
                    </div>
                </div>
            </g:form>
        </section>
